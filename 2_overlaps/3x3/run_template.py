...
params['lowest_orbital'] = 1152-100
params['highest_orbital'] = 1152+100
...
if params['is_periodic']:
    params['A_cell_vector'] = [42.7245407104   ,    0.0000000000    ,      0.0000000000]
    params['B_cell_vector'] = [0.0006454677    ,    37.0029029790   ,      0.0000000000]
...
if params['cube_visualization']:
    ...
    params['states_to_plot'] = list(range(1152-9,1152+11))
...
params['trajectory_xyz_filename'] = path + '/../../../1_molecular_dynamics/3x3/c3n4_3x3_MD_xTB-pos-1.xyz'
