...
params['lowest_orbital'] = 4608-100
params['highest_orbital'] = 4608+490
...
if params['is_periodic']:
    params['A_cell_vector'] = [85.4490585327   ,      0.0000000000  ,       0.0000000000]
    params['B_cell_vector'] = [0.0012909353    ,    74.0057983286   ,      0.0000000000]
...
if params['cube_visualization']:
    ...
    params['states_to_plot'] = list(range(4599,4619))
...
params['trajectory_xyz_filename'] = path + '/../../../1_molecular_dynamics/6x6/c3n4_6x6_MD_xTB-pos-1.xyz'
