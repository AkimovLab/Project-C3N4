...
params['lowest_orbital'] = 2048-100
params['highest_orbital'] = 2048+220
...
if params['is_periodic']:
    params['A_cell_vector'] = [56.9660415649     ,    0.0000000000    ,     0.0000000000]
    params['B_cell_vector'] = [ 0.0008606236     ,   49.3372001573    ,     0.0000000000]
...
if params['cube_visualization']:
    ...
    params['states_to_plot'] = list(range(2039,2059))
...
params['trajectory_xyz_filename'] = path + '/../../../1_molecular_dynamics/4x4/c3n4_4x4_MD_xTB-pos-1.xyz'
