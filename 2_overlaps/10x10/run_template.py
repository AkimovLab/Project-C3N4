...
params['lowest_orbital'] = 12800-100
params['highest_orbital'] = 12800+1000
...
if params['is_periodic']:
    params['A_cell_vector'] = [142.4151000977    ,     0.0000000000 ,        0.0000000000]
    params['B_cell_vector'] = [  0.0021515590    ,   123.3430023006 ,        0.0000000000]
...
if params['cube_visualization']:
    ...
    params['states_to_plot'] = list(range(12791,12811))
...
params['trajectory_xyz_filename'] = path + '/../../../1_molecular_dynamics/10x10/c3n4_10x10_MD_xTB-pos-1.xyz'
