...
params_sd = {
          'lowest_orbital': 512-20, 'highest_orbital': 512+21,
          ...
          'path_to_npz_files': os.getcwd()+'/../../2_overlaps/2x2/step2/res',
          'logfile_directory': os.getcwd()+'/../../2_overlaps/2x2/all_logfiles',
          'path_to_save_sd_Hvibs': os.getcwd()+'/res-mixed-basis-raw-ordered-identity',
          'outdir': os.getcwd()+'/res-mixed-basis-raw-not-ordered',
